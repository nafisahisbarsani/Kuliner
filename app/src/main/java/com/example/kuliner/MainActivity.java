...
import com.example.kuliner.fragments.FragmentMakananKhas;
import com.example.kuliner.fragments.FragmentMinumanKhas;
import com.example.kuliner.fragments.FragmentsMakananKesukaan;
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (itemId == R.id.menu_item1) {
                    ...
                    getSupportFragmentManager().beginTransaction()
                            .replace(R.id.content_frame, new FragmentsMakananKesukaan())
                            .commit();
